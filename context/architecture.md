...
flowchart LR
    ...
    D --> E[Resolve Slack IDs from GITHUB_TO_SLACK_JSON]
...
- `src/pr-feedback/slack-mapping.ts` parses `GITHUB_TO_SLACK_JSON`, resolves Slack recipients, and produces unmapped-user report data.
