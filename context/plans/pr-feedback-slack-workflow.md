...
- [ ] T01: `Define workflow contract and operator inputs` (status:todo)
  - Task ID: T01
...
- [ ] T02: `Add participant collection and normalization module` (status:todo)
  - Task ID: T02
...
- [ ] T03: `Add Slack identity mapping and missing-user reporting` (status:todo)
  - Task ID: T03
...
- [ ] T04: `Implement Slack DM delivery for PR feedback requests` (status:todo)
  - Task ID: T04
...
- [ ] T05: `Wire the closed-PR GitHub Action end to end` (status:todo)
  - Task ID: T05
...
- [ ] T06: `Document Slack setup and operating procedure` (status:todo)
  - Task ID: T06
...
- [ ] T07: `Validate implementation and sync context` (status:todo)
  - Task ID: T07
